...
{/* <section>
                <h2>
                    <span aria-hidden>☀️</span> Сонячна електростанція (СЕС)
                </h2>
                <ul>
                    <li>
                        <span className='font-medium text-slate-900'>Встановлена потужність:</span> 14&nbsp;396,20 МВт
                    </li>
                    <li>
                        <span className='font-medium text-slate-900'>Потужність видачі:</span> 10,5 МВт
                    </li>
                </ul>
                <p>
                    Сонячна електростанція <span className='font-semibold text-slate-900'>{COMPANY_NAME}</span> здійснює виробництво електричної енергії шляхом перетворення
                    сонячного випромінювання у електричну енергію.
                </p>
                <p>Об’єкт відповідає технічним та екологічним вимогам.</p>
            </section> */}
...
<section>
<h2>
    <span aria-hidden>🔥</span> Когенераційна установка (КГУ)
</h2>
<p>
    До складу когенераційного комплексу <span className='font-semibold text-slate-900'>{COMPANY_NAME}</span> входять установки типу RSE:
</p>
<ul>
    <li>2 установки по 2,0 МВт</li>
    <li>2 установки по 2,3 МВт</li>
</ul>
<p>
